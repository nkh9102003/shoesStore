                        ...
                        <div class="col-sm-4">
                            <div class="card product-card">
                                <div class="box">
                                    ...
                                    <div class="middle">
                                        <div class="text" onclick="">Xem chi tiết</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php
                                        if(isset($_SESSION['user_id'])){
                                            ?>
                                            <button id="addToCartBtn<?=$row['IdSP']?>" type="button" onclick="" class="btn btn-success" name="addToCart">Thêm vào giỏ hàng</button>
                                            <?php
                                        }else{
                                            ?>
